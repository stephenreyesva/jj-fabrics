...
function renderProducts() {
  ...
  grid.innerHTML=prods.map(p=>{
    ...
    const newBadge=isNew?`<span style="position:absolute;top:0;left:0;z-index:3;width:80px;height:80px;overflow:hidden;pointer-events:none;"><span style="position:absolute;top:16px;left:-24px;width:100px;height:20px;background:#cc0000;transform:rotate(-45deg);box-shadow:0 2px 6px rgba(0,0,0,0.35);display:block;"></span></span>`:'';
