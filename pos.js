...
function renderProducts() {
  ...
  grid.innerHTML=prods.map(p=>{
    ...
    const rWrap='position:absolute;top:0;left:0;z-index:3;width:110px;height:110px;overflow:hidden;pointer-events:none;border-radius:8px 0 0 0;';
    const rBar='position:absolute;top:28px;left:-32px;width:140px;height:32px;background:linear-gradient(to bottom,#e8000d,#c20009);transform:rotate(-45deg);display:block;text-align:center;line-height:32px;font-size:11px;font-weight:900;letter-spacing:2px;color:#fff;text-transform:uppercase;box-shadow:0 4px 14px rgba(0,0,0,0.7),inset 0 1px 0 rgba(255,255,255,0.2);';
    const saleWrap='position:absolute;top:0;right:0;z-index:3;width:110px;height:110px;overflow:hidden;pointer-events:none;border-radius:0 8px 0 0;';
    const saleBar='position:absolute;top:28px;right:-32px;width:140px;height:32px;background:linear-gradient(to bottom,#f5c800,#d4a800);transform:rotate(45deg);display:block;text-align:center;line-height:32px;font-size:10px;font-weight:900;letter-spacing:1.5px;color:#111;text-transform:uppercase;box-shadow:0 4px 14px rgba(0,0,0,0.5),inset 0 1px 0 rgba(255,255,255,0.3);';
    const newBadge=isNew?`<span style="${rWrap}"><span style="${rBar}">NEW</span></span>`:'';
    const saleBadge=isSale?`<span style="${saleWrap}"><span style="${saleBar}">SALE</span></span>`:'';
