...
function renderProducts() {
  ...
  grid.innerHTML=prods.map(p=>{
    ...
    const newBadge=isNew?`<span style="position:absolute;top:0;left:0;z-index:3;width:72px;height:72px;overflow:hidden;pointer-events:none;"><span style="position:absolute;top:17px;left:-20px;width:82px;height:20px;background:linear-gradient(180deg,#e8000d,#b00009);transform:rotate(-45deg);display:block;text-align:center;line-height:20px;font-size:8px;font-weight:900;letter-spacing:1.5px;color:#fff;text-transform:uppercase;box-shadow:0 2px 6px rgba(0,0,0,0.35),inset 0 1px 0 rgba(255,255,255,0.2);">NEW</span></span>`:'';
